...
# font for score
font = pygame.font.SysFont(None,40) # you can also pass SysFont(name, size, bold=False, italic=False)
...
def text_screen(text,color,x,y):
    screen_text = font.render(text,True,color) #  you can also pass render(text, antialias, color, background=None) => here, antialiasing is for smooth rendering!
